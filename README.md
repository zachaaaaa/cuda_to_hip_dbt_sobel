...
Note:
-This project was built and tested without direct access to an AMD GPU. Instead, the HIP portion was developed and validated using the official ROCm Docker image to ensure full software-side correctness and compatibility.
